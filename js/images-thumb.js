const thumbs = {
  ...
  init: function(){
    ...
    thumbs.imgThumbs = document.querySelectorAll('.product__image-thumbs-container'); // tableau thumbs containers
    for (const imgThumb of thumbs.imgThumbs) {
